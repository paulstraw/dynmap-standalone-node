import { TileLayer, point, DomUtil, bounds as boundz } from 'leaflet'
...
export default TileLayer.extend({
  ...
  getTileUrl: function(tilePoint, zoom) {
    ...
    if (!url) {
      this._cachedTileUrls[tileName] = url = this.options.dynmap.getTileUrl(
        tileName
      )
    }
    return url
  ...
  _update: function() {
    ...
    var nwTilePoint = point(
      ...
      tileBounds = boundz(nwTilePoint, seTilePoint)
